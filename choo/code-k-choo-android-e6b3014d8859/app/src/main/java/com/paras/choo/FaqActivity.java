...
//            toolbar.setTitleTextColor(Color.parseColor("#ffffff"));
        ...
        if("en".equals(getString(R.string.lang)) ) {
            File myFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/cache/faq.html");
            if (myFile.exists()) {
                Log.e("", "File EXISTS");
                webView.loadUrl("file://" + Environment.getExternalStorageDirectory() + "/cache/faq.html");
            } else {
                Log.e("", "File Not EXISTS");
                webView.loadUrl("file:///android_asset/faq.html");
            }
        }else{
            File myFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/cache/faq_de.html");
            if (myFile.exists()) {
                Log.e("", "File EXISTS");
                webView.loadUrl("file://" + Environment.getExternalStorageDirectory() + "/cache/faq_de.html");
            } else {
                Log.e("", "File Not EXISTS");
...
//            overridePendingTransition(R.animator.card_flip_right_in, R.animator.card_flip_right_out);
    ...
    public class LoadHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                HttpGet request = new HttpGet("http://www.chooapp.com/iOS_files/en/en_app_faq.html");
    ...
    public class DownloadHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                HtmlDownloadhelper.saveHtmlFile("faq.html", context, "http://www.chooapp.com/iOS_files/en/en_app_faq.html");
            } catch (Exception e) {
                e.printStackTrace();
            }
            return result;
    ...
    public class LoadDeHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                HttpClient client = HttpClientBuilder.create().build();
                HttpGet request = new HttpGet("http://www.chooapp.com/iOS_files/app_faq.html");
                HttpResponse response = client.execute(request);
                result = EntityUtils.toString(response.getEntity());
                Log.e("", "result" + result);
                server = response.getFirstHeader("Last-Modified").getValue();
    ...
    public class DownloadDeHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                HtmlDownloadhelper.saveHtmlFile("faq_de.html", context, "http://www.chooapp.com/iOS_files/app_faq.html");
            } catch (Exception e) {
                e.printStackTrace();
            }
            return result;
