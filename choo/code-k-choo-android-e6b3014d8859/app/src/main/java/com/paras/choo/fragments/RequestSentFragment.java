 ...
 * {@link RequestSentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RequestSentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RequestSentFragment extends Fragment implements LocationListener {
    ...
    TextView heading, text1, text2, text3, text4, text5, text6, text7, text8;
    GoogleMap googleMap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_request_sent, container, false);
        ...
        text4.setTypeface(fieldsfont);
        text5.setTypeface(fieldsfont);
        text6.setTypeface(fieldsfont);
        text7.setTypeface(fieldsfont);
        text8.setTypeface(fieldsfont);
