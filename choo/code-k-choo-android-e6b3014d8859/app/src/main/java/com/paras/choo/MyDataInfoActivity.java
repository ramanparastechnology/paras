...
public class MyDataInfoActivity extends ActionBarActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if("en".equals( getString(R.string.lang) ) ) {
            File myFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/cache/mydata.html");
            if (myFile.exists()) {
                Log.e("", "File EXISTS");
                webView.loadUrl("file://" + Environment.getExternalStorageDirectory() + "/cache/mydata.html");
            } else {
                Log.e("", "File Not EXISTS");
                webView.loadUrl("file:///android_asset/mydata.html");
            }
        }else{
            File myFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/cache/mydata_de.html");
            if (myFile.exists()) {
                Log.e("", "File EXISTS");
                webView.loadUrl("file://" + Environment.getExternalStorageDirectory() + "/cache/mydata_de.html");
            } else {
                Log.e("", "File Not EXISTS");
                webView.loadUrl("file:///android_asset/mydata_de.html");
            }
        }
    }
...
//            overridePendingTransition(R.animator.card_flip_right_in, R.animator.card_flip_right_out);
    ...
    public class LoadHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                HttpGet request = new HttpGet("http://www.chooapp.com/iOS_files/en/en_app_myaccount-info.html");
    ...
    public class DownloadHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                HtmlDownloadhelper.saveHtmlFile("mydata.html", context, "http://www.chooapp.com/iOS_files/en/en_app_myaccount-info.html");
            } catch (Exception e) {
                e.printStackTrace();
            }
            return result;
    ...
    public class LoadDeHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                HttpClient client = HttpClientBuilder.create().build();
                HttpGet request = new HttpGet("http://www.chooapp.com/iOS_files/app_myaccount-info.html");
                HttpResponse response = client.execute(request);
                result = EntityUtils.toString(response.getEntity());
                Log.e("","result"+result);
                //get header by 'key'
    ...
    public class DownloadDeHtml extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                HtmlDownloadhelper.saveHtmlFile("mydata_de.html", context, "http://www.chooapp.com/iOS_files/app_myaccount-info.html");
            } catch (Exception e) {
                e.printStackTrace();
            }
            return result;
